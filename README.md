...
-> Average occupancy rate per room categories, cities, type of day(weekday or weekend)
...
Makeyourtrip is the booking platform which brings in the highest revenue realized across all the booking platforms.
## Workflow

1. Understanding the business problem - Defined Key business Objectives 
...
1. Delhi has the highest occupancy but low revenue 
        
        Review the pricing strategy in Delhi
2. Standard rooms have the lowest occupancy
        
        Use standard rooms for OTA flash sales during low-demand periods.
